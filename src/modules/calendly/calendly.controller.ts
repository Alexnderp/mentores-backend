...
export class CalendlyController {
  constructor(
    ...
    private deleteCalendyInfoService: DeleteCalendlyInfoService,
  ) {}
  ...
  @Delete(':id')
  async DeleteCalendlyInfoService(@LoggedEntity() mentor: MentorEntity) {
    return await this.deleteCalendyInfoService.execute(mentor.id);
  }
}
